...
export const AnalyticsAIFeedback: FC<Props> = ({ summaryData, isLoading, onClick }) => {
  return (
    <div className="mt-4">
      <button
        type="button"
        className="flex gap-2 items-center text-md text-white bg-rhyth-light-blue hover:bg-rhyth-blue disabled:bg-rhyth-light-gray border border-rhyth-blue disabled:border-rhyth-light-gray rounded-lg px-4 py-1 mx-auto"
        disabled={isLoading}
        onClick={onClick}
      >
        <svg
