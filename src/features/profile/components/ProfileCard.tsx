    ...
    <div className="w-screen justify-center pt-24 -mt-24 pb-8 bg-white bg-cover bg-[url('/bg-geometric2.png')] border border-gray-200 shadow">
      <div className="flex px-4 max-w-[680px] mx-auto justify-between items-center box-border">
        ...
        <div className="flex flex-col">
          <p className="text-4xl font-extrabold text-right text-black">{userName}</p>
          <div className="flex justify-end items-end gap-3 focus:outline-none focus:ring-4 font-extrabold text-2xl text-black">
